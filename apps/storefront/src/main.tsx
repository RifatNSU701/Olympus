...
function App() {
  return <div className="app">
    ...
    <main>
      ...
      <section className="discover" id="shop"><div><span className="eyebrow">DISCOVER OLYMPUS</span><h2>Built for people<br/>who expect more.</h2></div><button className="round"><ArrowRight/></button></section>
    </main>
